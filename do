...
function footer() {
  ...
  print "<p style=\"border: 1px solid #BBB; border-radius: 4px; padding: 20px; background-color: #dbffa3;\"><img src=\"img/arrow.jpg\" alt=\"arrowhead\" width=\"100%\"/><br/>Archaeological sites near Wales, Alaska, on the coast of Bering Strait, exist at a crossroads of continents and provide a rich sequence of human activity for over 1,200 years. Wales was the site of ten years of recent archaeological investigations, which produced approximately 30,000 artifacts, faunal and floral remains, and sediment samples.<br/><br/>This website offers access to the Wales collections at the <a href=\"https://www.uaf.edu/museum/collections/archaeo/\">University of Alaska Museum of the North</a>. Website development funded by US NSF grant <a href=\"https://www.nsf.gov/awardsearch/showAward?AWD_ID=2040323\">2040323</a>.</p>"
  print "</div></div></div>"
